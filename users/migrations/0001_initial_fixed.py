# C:\Users\ASUS\MyanmarTravelPlanner\users\migrations\0001_initial_fixed.py
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                # USERNAME FIELD - NON-UNIQUE (allows duplicates)
                ('username', models.CharField(
                    max_length=150,
                    unique=False,  # CHANGED: This allows duplicate usernames
                    help_text='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.',
                )),
                # EMAIL FIELD - UNIQUE (no duplicates)
                ...
                ('followers', models.ManyToManyField(blank=True, related_name='following', to='users.customuser')),
